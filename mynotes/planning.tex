...
\begin{itemize}
    ...
    \item Action: $\text{move}(X,Y)$ to move $X$ to be on top of $Y$
    \begin{itemize}
        \item Pre: $\text{cl}(Y), \text{cl}(X), \text{on}(X,Z)$
        \item Add: $\text{cl}(Z), \text{on}(X,Y)$
        \item Del: $\text{cl}(Y), \text{on}(X,Z)$
    \end{itemize}
\end{itemize}

\begin{figure}[H]
    \includegraphics[width=0.5\linewidth]{images/sussman.png}
\end{figure}

Here is the \linkterm{totally ordered plan}{totally_ordered} to solve the problem:
\begin{figure}[H]
    \includegraphics[width=0.5\linewidth]{images/sussman_sol.png}
\end{figure}
...
We expand $DD$:
\begin{figure}[H]
    \includegraphics[width=0.5\linewidth]{images/p16.png}
\end{figure}

We expand $CD$:
\begin{figure}[H]
    \includegraphics[width=0.5\linewidth]{images/p17.png}
\end{figure}

We expand $BD$:
\begin{figure}[H]
    \includegraphics[width=0.5\linewidth]{images/p18.png}
\end{figure}
